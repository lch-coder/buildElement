...
<template>
  <div title="分步表单" desc="将一个冗长或用户不熟悉的表单任务分成多个步骤，指导用户完成。" />
    ...
    <div class="max-w-400px mx-auto py-3">
      <el-form ref="form$" label-position="top" :model="form" :rules="rules">
        ...
        <template v-else-if="currentStep === 1">
          ...
          <el-form-item>
            <el-button type="primary" @click="stepNext()"> 确认转账 </el-button>
        ...
        <template v-if="currentStep === 2">
          <el-result icon="success" title="操作成功" sub-title="预计两小时内到账">
            <template #extra>
              <el-button type="primary" @click="restart"> 再转一笔 </el-button>
